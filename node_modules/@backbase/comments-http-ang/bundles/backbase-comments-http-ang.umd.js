(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@backbase/comments-http-ang', ['@angular/core','@angular/common/http','exports', '@angular/core', '@angular/common/http'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.common.http,(global.backbase = global.backbase || {}, global.backbase['comments-http-ang'] = {}), global.ng.core, global.ng.common.http));
    ...
    var CommentsService = /** @class */ (function () {
        function CommentsService(httpClient, basePath, configuration) {
            ...
            this.basePath = 'http://localhost:5600/client-api/comments/v2';
        ...
        CommentsService.prototype.addPost = function (threadId, postAddDto, observe, reportProgress, options) {
            ...
            return this.httpClient.post(this.configuration.basePath + "/client-api/comments/v2/threads/" + encodeURIComponent(String(threadId)) + "/posts", postAddDto, {
        ...
        CommentsService.prototype.addThread = function (threadAddDto, observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            ...
            return this.httpClient.post(this.configuration.basePath + "/client-api/comments/v2/threads", threadAddDto, {
                responseType: responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
        ...
        CommentsService.prototype.deletePost = function (threadId, postId, observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            if (threadId === null || threadId === undefined) {
            ...
            return this.httpClient.delete(this.configuration.basePath + "/client-api/comments/v2/threads/" + encodeURIComponent(String(threadId)) + "/posts/" + encodeURIComponent(String(postId)), {
                responseType: responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
        ...
        CommentsService.prototype.getPostList = function (threadId, observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            if (threadId === null || threadId === undefined) {
            ...
            return this.httpClient.get(this.configuration.basePath + "/client-api/comments/v2/threads/" + encodeURIComponent(String(threadId)) + "/posts", {
                responseType: responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
        ...
        CommentsService.prototype.getThreadList = function (entityFilter, observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            ...
            if (entityFilter !== undefined && entityFilter !== null) {
                queryParameters = this.addToHttpParams(queryParameters, entityFilter, 'entityFilter');
            }
            var headers = this.defaultHeaders;
            var credential;
            // authentication (bearerAuth) required
        ...
        CommentsService.prototype.updatePost = function (threadId, postId, postUpdateDto, observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            if (threadId === null || threadId === undefined) {
            ...
            return this.httpClient.put(this.configuration.basePath + "/client-api/comments/v2/threads/" + encodeURIComponent(String(threadId)) + "/posts/" + encodeURIComponent(String(postId)), postUpdateDto, {
                responseType: responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
...
CommentsService.ɵfac = function CommentsService_Factory(t) { return new (t || CommentsService)(ɵngcc0.ɵɵinject(ɵngcc1.HttpClient), ɵngcc0.ɵɵinject(BASE_PATH, 8), ɵngcc0.ɵɵinject(Configuration, 8)); };
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CommentsService, [{
        type: i0.Injectable,
        args: [{
                providedIn: 'root'
            }]
    ...
    CommentsService.ɵprov = i0.ɵɵdefineInjectable({ factory: function CommentsService_Factory() { return new CommentsService(i0.ɵɵinject(i1.HttpClient), i0.ɵɵinject(BASE_PATH, 8), i0.ɵɵinject(Configuration, 8)); }, token: CommentsService, providedIn: "root" });
...
//# sourceMappingURL=backbase-comments-http-ang.umd.js.map