...
class CommentsService {
    ...
    addPost(threadId, postAddDto, observe = 'body', reportProgress = false, options) {
    ...
    addThread(threadAddDto, observe = 'body', reportProgress = false, options) {
    ...
    deletePost(threadId, postId, observe = 'body', reportProgress = false, options) {
        if (threadId === null || threadId === undefined) {
    ...
    getPostList(threadId, observe = 'body', reportProgress = false, options) {
        if (threadId === null || threadId === undefined) {
    ...
    getThreadList(entityFilter, observe = 'body', reportProgress = false, options) {
    ...
    updatePost(threadId, postId, postUpdateDto, observe = 'body', reportProgress = false, options) {
        if (threadId === null || threadId === undefined) {
...
CommentsService.ɵprov = ɵɵdefineInjectable({ factory: function CommentsService_Factory() { return new CommentsService(ɵɵinject(HttpClient), ɵɵinject(BASE_PATH, 8), ɵɵinject(Configuration, 8)); }, token: CommentsService, providedIn: "root" });
...
export { APIS, ApiModule, BASE_PATH, COLLECTION_FORMATS, CommentsService, Configuration, ThreadDto };

//# sourceMappingURL=backbase-comments-http-ang.js.map