...
/// @access public
$icon-custom-category-color: $color-secondary !default;
...
$deprecated-category-list: (
  ...
  ("groceries", "bicon-restaurant", $icon-custom-category-color),
  ...
  ("electronics", "bicon-shopping-cart", $icon-custom-category-color),
  ("internet", "bicon-description", $icon-custom-category-color),
  ("mobile-phone", "bicon-description", $icon-custom-category-color),
  ("utilities", "bicon-description", $icon-custom-category-color),
...
$category-list: (
  ...
  ("personal-care", "bicon-hot-tub", $icon-custom-category-color),
  ("pets", "bicon-pets", $icon-custom-category-color),
  ("shopping", "bicon-shopping-cart", $icon-custom-category-color),
  ("taxes", "bicon-monetization-on", $icon-custom-category-color),
  ...
  ("insurance", "bicon-security", $icon-custom-category-color),
  ("real-estate", "bicon-business", $icon-custom-category-color),
  ("services", "bicon-shopping-basket", $icon-custom-category-color),
...
$retail-category-list: (
  ...
  ("other-income", "bicon-toll", $icon-custom-category-color)
);
...
$account-kind-color-list: (
  "current-account": $chart-color-6,
  "savings-account": $chart-color-8,
  "term-deposit": $chart-color-1,
  "credit-card": $chart-color-7,
  "debit-card": $chart-color-7,
  "loan": $chart-color-4,
  "investment-account": $chart-color-1,
) !default;
