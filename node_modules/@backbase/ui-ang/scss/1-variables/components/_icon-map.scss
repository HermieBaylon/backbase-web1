////
/// Icons Map for bb-icon-ui (global)
/// Further extended via map-merge for categories, delivery-tracker
/// [Key: bicon class name] : [Value: 'content' value]
/// @group 1-variables/components/icon-map
/// @access private
////
