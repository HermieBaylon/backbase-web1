...
$heading-widget-padding-top: 5rem !default; // intentional non-standard sizing; not using $sizer
$heading-widget-padding-bottom: $spacer-xl !default;
$heading-widget-padding-x: $spacer-xl !default;
$heading-widget-padding-x-sm: $spacer-lg !default;
/// @name $heading-widget-de-elevated-padding-bottom
$heading-widget-de-elevated-padding-bottom: 14rem !default;
$heading-widget-de-elevated-sizer-horizontal: $sizer-sm !default;
$heading-widget-border-radius: $border-radius-md !default;
$heading-widget--buton-above-padding-top: $spacer-xl !default;

.bb-heading-widget {
  display: flex;
  align-items: center;
  justify-content: space-between;
  padding: $heading-widget-padding-top $heading-widget-padding-x $heading-widget-padding-bottom;
  @include border-radius($heading-widget-border-radius);

  @include media-breakpoint-down(sm) {
    padding-right: $heading-widget-padding-x-sm;
    padding-left: $heading-widget-padding-x-sm;
...
.bb-heading-widget--de-elevated {
  padding-bottom: $heading-widget-de-elevated-padding-bottom;
  background-image: $heading-widget-background;

  @include media-breakpoint-down(sm) {
    margin-right: -#{$heading-widget-de-elevated-sizer-horizontal};
    margin-left: -#{$heading-widget-de-elevated-sizer-horizontal};
  }
}
...
.bb-heading-widget--button-above {
  ...
  align-items: flex-start;
  justify-content: space-between;
  padding-top: $heading-widget--buton-above-padding-top;
