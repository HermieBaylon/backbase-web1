...
$notification-padding-right: 2 * $sizer-lg !default;
...
.bb-notification {
  ...
  padding: $notification-padding $notification-padding-right $notification-padding
...
.bb-notification--flush {
  width: 100%;
  padding: $sizer-md $card-md-sizer;
