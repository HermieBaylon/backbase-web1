...
.container {
  display: block;
  padding: $container-padding-y-lg $container-padding-x-lg;

  @include media-breakpoint-down(md) {
    padding: $container-padding-y-md $container-padding-x-md;
  }
...
.container-fluid {
  ...
  @include media-breakpoint-down(sm) {
    padding: $container-padding-y-md $container-padding-x-sm;
  }
}
...
/// @require {variable} $heading-widget-de-elevated-padding-bottom
.container--drag-up {
  margin-top: calc(#{$spacer-lg} - #{$heading-widget-de-elevated-padding-bottom});
