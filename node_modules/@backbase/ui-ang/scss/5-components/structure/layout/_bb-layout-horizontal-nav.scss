...
$layout-horizontal-nav-dropdown-background-color: $color-primary !default;
...
$layout-horizontal-nav-submenu-column-width: 18.2 * $sizer !default;
...
$layout-horizontal-nav-submenu-link-color: $color-neutral-white !default;
...
$layout-horizontal-nav-expanded-link-color: $color-neutral-black !default;
...
@mixin horizontal-nav-menubar {
  ...
  .bb-layout__horizontal-nav-link {
    ...
    &:focus {
      ...
      border-bottom: $layout-horizontal-nav-link-border-height solid
        $layout-horizontal-nav-link-hover-border-color;
    }
    ...
    &.bb-layout__horizontal-nav-link--expanded {
      ...
      border-bottom: $layout-horizontal-nav-link-border-height solid
        $layout-horizontal-nav-link-active-border-color;
    }
  }
...
@mixin horizontal-nav-dropdown-menu {
  ...
  background-color: $layout-horizontal-nav-dropdown-background-color;
