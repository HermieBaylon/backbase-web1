...
.bb-sidebar__sidebar-toggler {
  ...
  padding: $sidebar-sidebar-toggler-y-padding $sidebar-sidebar-toggler-x-padding;
  line-height: 0.5;
...
@include media-breakpoint-between(xs, md) {
  .bb-sidebar {
    padding-right: $page-layout-section-padding-narrow;
    padding-left: $page-layout-section-padding-narrow;
  }
  .bb-sidebar--collapsed {
