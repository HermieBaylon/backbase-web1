...
.bb-product-summary-account-selector {
  ...
  .bb-product-item__title {
    flex: none;
    margin-bottom: $product-summary-account-selector-item-padding;
  }
  ...
  .bb-account-selector {
    ...
    &.ng-select.ng-select-multiple {
      .ng-select-container {
        height: auto;
        padding: 0 $product-summary-account-selector-option-padding;
        > .ng-value-container {
          .ng-value {
            padding-top: $product-summary-account-selector-option-padding;
            padding-bottom: calc(
      ...
      @include media-breakpoint-down(xs) {
        .ng-select-container {
          padding: 0 $product-summary-account-selector-item-padding;
          > .ng-value-container {
            .ng-value {
              padding-top: $product-summary-account-selector-item-padding;
              padding-bottom: 0;
            }
          }
        }
...
.bb-product-summary-account-selector__external-title {
  padding-left: map-get($icon-background-size-map, "md");
}
