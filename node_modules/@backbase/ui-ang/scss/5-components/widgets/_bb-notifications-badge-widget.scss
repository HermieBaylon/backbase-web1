...
.bb-notifications-badge-widget__dropdown-button {
  ...
  &:focus {
    outline: none;
    box-shadow: $notifications-badge-focus-box-shadow;
  }
}

.bb-notifications-badge-widget__dropdown-button-counter {
  position: absolute;
  top: $notification-badge-counter-top;
  left: $notification-badge-counter-left;
}
...
.bb-notifications-badge-widget__load-new-button {
  padding: $sizer-md $sizer-lg $sizer-md $sizer-md;
...
.bb-notifications-badge-list-item--unread {
  .bb-notifications-badge-list-item__header {
    ...
    &::after {
      position: absolute;
      top: $notifications-badge-list-item-unread-mark-top;
      right: 0;
      display: block;
      width: $notifications-badge-list-item-unread-mark-size;
      height: $notifications-badge-list-item-unread-mark-size;
      margin-top: -$notifications-badge-list-item-unread-mark-size/2;
