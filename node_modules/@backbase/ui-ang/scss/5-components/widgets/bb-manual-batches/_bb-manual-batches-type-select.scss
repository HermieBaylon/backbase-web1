...
$manual-batches-type-select-btn-width: 190px !default;
$manual-batches-type-select-height: 92px !default;
$manual-batches-type-select-bg-color: $color-neutral-light !default;
$manual-batches-type-select-selected-bg-color: $color-primary !default;
$manual-batches-type-select-hover-text-color: #fff !default;
$manual-batches-type-select-hover-bg-color: $color-primary-darkest !default;
