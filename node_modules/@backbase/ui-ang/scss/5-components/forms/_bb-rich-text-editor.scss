...
.bb-rich-text-editor__actionbar {
  ...
  &.ng-invalid.ng-touched:not(.is-focused) .form-control {
    border: $bb-rich-text-editor-content-invalid-border;
  }

  &.is-focused {
    .form-control {
      border-color: $bb-rich-text-editor-content-focus-border-color;
...
.bb-rich-text-editor__toolbar-separator {
  ...
  width: $bb-rich-text-editor-toolbar-separator-width;
}
