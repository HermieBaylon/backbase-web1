...
.btn {
  ...
  @if $experimental-enable-focus {
    ...
    &:not(.btn-unstyled) {
      &:focus::before {
        position: absolute;
        top: $btn-focus-outline-distance;
        right: $btn-focus-outline-distance;
        bottom: $btn-focus-outline-distance;
        left: $btn-focus-outline-distance;
    ...
    &:is(.btn-link-text) {
      &:focus::before {
        top: $btn-focus-outline-distance/4;
        right: $btn-focus-outline-distance/2;
        bottom: $btn-focus-outline-distance/4;
        left: $btn-focus-outline-distance/2;
...
.btn-unstyled--focusable {
  ...
  @if $experimental-enable-focus {
    &:focus::before {
      position: absolute;
      top: $btn-focus-outline-distance / 2;
      right: $btn-focus-outline-distance / 2;
      bottom: $btn-focus-outline-distance / 2;
      left: $btn-focus-outline-distance / 2;
      border: $btn-focus-border-primary;
      content: "";
    }
