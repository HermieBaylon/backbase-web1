...
$list-multiple-select-input-checkbox-padding-bottom: $sizer-sm !default;
$list-multiple-select-divider-margin-top: $sizer-sm !default;
$list-multiple-select-divider-margin-bottom: $sizer-sm !default;
$list-multiple-select-divider-margin-left: $sizer !default;
$list-multiple-select-divider-margin-right: $sizer !default;
...
.bb-list-multiple-select__dropdown-divider {
  margin-top: $list-multiple-select-divider-margin-top;
  margin-right: $list-multiple-select-divider-margin-right;
  margin-bottom: $list-multiple-select-divider-margin-bottom;
  margin-left: $list-multiple-select-divider-margin-left;
  overflow: hidden;
...
.bb-list-multiple-select__list {
  ...
  .bb-input-checkbox {
    display: flex;
    padding-bottom: $list-multiple-select-input-checkbox-padding-bottom;
  }
}
