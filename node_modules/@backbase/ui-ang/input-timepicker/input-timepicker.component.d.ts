 ...
 */
export declare class InputTimepickerComponent extends InputBaseComponent implements Validator, AfterViewInit {
     ...
     */
    constructor(cd: ChangeDetectorRef, domAttrService: DomAttributesService, elem: ElementRef, renderer2: Renderer2, deprecationsService: DeprecationsService);
    ngAfterViewInit(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<InputTimepickerComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<InputTimepickerComponent, "bb-input-timepicker-ui", never, { "hourStep": "hourStep"; "clock": "clock"; "minuteStep": "minuteStep"; "readonly": "readonly"; "seconds": "seconds"; "secondStep": "secondStep"; "min": "min"; "max": "max"; "autocomplete": "autocomplete"; }, {}, never, never>;
}
