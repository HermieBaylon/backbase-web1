(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@backbase/ui-ang/iban-lib', ['exports'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.backbase = global.backbase || {}, global.backbase["ui-ang"] = global.backbase["ui-ang"] || {}, global.backbase["ui-ang"]["iban-lib"] = {})));
     ...
     * return {boolean}
     */
    var alreadyExploded = function (str, symbol) { return str && str.split(symbol).length > 1; };
    /**
     * name explodeString
     * type {function}
     *
     ...
     * return {string}
     */
    var explodeString = function (str, symbol, groupLen) {
        if (symbol === void 0) { symbol = ' '; }
        if (groupLen === void 0) { groupLen = 4; }
     ...
     * @example: NL91ABNA0417164300
     */
    function isValidIBANFormControl(control) {
     ...
     * return {string}
     */
    function formatByGroups(str, symbol, groupLen) {
    ...
    exports.formatByGroups = formatByGroups;
    exports.isValidBBAN = isValidBBAN;
    exports.isValidIBAN = isValidIBAN;
    exports.isValidIBANFormControl = isValidIBANFormControl;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=backbase-ui-ang-iban-lib.umd.js.map
