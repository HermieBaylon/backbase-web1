...
export declare class NewAddressComponent implements OnDestroy {
    ...
    readonly handleServiceResponse: () => (source: Observable<HttpResponse<undefined>>) => Observable<HttpResponse<undefined> | undefined>;
    private readonly onFormSubmissionSuccessful;
    private readonly onFormSubmissionUnsuccessful;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<NewAddressComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<NewAddressComponent, "ng-component", never, { "notificationDismissTime": "notificationDismissTime"; }, { "close": "close"; "closeAfterSave": "closeAfterSave"; }, never, never>;
}
