(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@backbase/cashflow-http-ang', ['exports', '@angular/core', '@angular/common/http', '@backbase/foundation-ang/data-http'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.backbase = global.backbase || {}, global.backbase["cashflow-http-ang"] = {}), global.ng.core, global.ng.common.http, global.i2));
    ...
    var PresentationAccountCategory = {
        Asset: 'Asset',
        Expense: 'Expense',
        Income: 'Income',
        Liability: 'Liability',
    ...
    var PresentationAuthorizationStatus = {
        PendingInitialAuth: 'PendingInitialAuth',
        Authorized: 'Authorized',
        Deauthorized: 'Deauthorized'
    };

    var PresentationCounterpartyType = {
        Customer: 'Customer',
        Supplier: 'Supplier'
    };

    var PresentationPayableStatus = {
        Draft: 'Draft',
        Open: 'Open',
    ...
    var PresentationReceivableStatus = {
        Draft: 'Draft',
        Submitted: 'Submitted',
        PartiallyPaid: 'PartiallyPaid',
        Paid: 'Paid'
    ...
    var CASH_FLOW_BASE_PATH = new i0.InjectionToken('CASH_FLOW_BASE_PATH');
    ...
    var CashFlowConfiguration = /** @class */ (function () {
        function CashFlowConfiguration(configurationParameters) {
        ...
        CashFlowConfiguration.prototype.selectHeaderContentType = function (contentTypes) {
            var _this = this;
        ...
        CashFlowConfiguration.prototype.selectHeaderAccept = function (accepts) {
            var _this = this;
            if (accepts.length === 0) {
                return undefined;
            }
        ...
        CashFlowConfiguration.prototype.isJsonMime = function (mime) {
            var jsonMime = new RegExp('^(application\/json|[^;/ \t]+\/[^;/ \t]+[+]json)[ \t]*(;.*)?$', 'i');
            return mime !== null && (jsonMime.test(mime) || mime.toLowerCase() === 'application/json-patch+json');
        };
        CashFlowConfiguration.prototype.lookupCredential = function (key) {
            var value = this.credentials[key];
            return typeof value === 'function'
                ? value()
                : value;
        };
        return CashFlowConfiguration;
    }());
    var CONFIG_TOKEN = new i0.InjectionToken('api-data-module CashFlowConfiguration');

    var CashFlowApiModule = /** @class */ (function () {
        function CashFlowApiModule(parentModule, http, dataModulesManager, config) {
            if (parentModule) {
        ...
        CashFlowApiModule.forRoot = function (configurationFactory) {
            return {
                ngModule: CashFlowApiModule,
                providers: [{ provide: CashFlowConfiguration, useFactory: configurationFactory }]
            };
        };
        return CashFlowApiModule;
    }());
    CashFlowApiModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: CashFlowApiModule, deps: [{ token: CashFlowApiModule, optional: true, skipSelf: true }, { token: i1__namespace.HttpClient, optional: true }, { token: i2__namespace.DataModulesManager, optional: true }, { token: CashFlowConfiguration }], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    CashFlowApiModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: CashFlowApiModule });
    CashFlowApiModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: CashFlowApiModule, providers: [], imports: [[]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: CashFlowApiModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [],
                        declarations: [],
            ...
            return [{ type: CashFlowApiModule, decorators: [{
                            type: i0.Optional
                        }, {
                            type: i0.SkipSelf
    ...
    var AccountingPlatformsHttpService = /** @class */ (function () {
        function AccountingPlatformsHttpService(httpClient, basePath, configuration) {
        ...
        AccountingPlatformsHttpService.prototype.addToHttpParams = function (httpParams, value, key) {
        ...
        AccountingPlatformsHttpService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
            var _this = this;
            if (value == null) {
                return httpParams;
            }
        ...
        AccountingPlatformsHttpService.prototype.getAccountingPlatforms = function (observe, reportProgress, options) {
        ...
        AccountingPlatformsHttpService.prototype.getAccountingPlatformsUrl = function () {
            return this.configuration.basePath + "/client-api/v1/accounting-platforms";
        };
        return AccountingPlatformsHttpService;
    }());
    AccountingPlatformsHttpService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: AccountingPlatformsHttpService, deps: [{ token: i1__namespace.HttpClient }, { token: CASH_FLOW_BASE_PATH, optional: true }, { token: CashFlowConfiguration, optional: true }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    AccountingPlatformsHttpService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: AccountingPlatformsHttpService, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: AccountingPlatformsHttpService, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root'
                    }]
    ...
    var AccountingPlatformsHttpServiceGetAccountingPlatformsMocksProvider = i2.createMocks([{
    ...
    var AccountingPlatformsHttpServiceMocksProvider = i2.createMocks([
        {
            urlPattern: "/client-api/v1/accounting-platforms",
            method: "GET",
            responses: [
    ...
    var ChartOfAccountsHttpService = /** @class */ (function () {
        function ChartOfAccountsHttpService(httpClient, basePath, configuration) {
            this.httpClient = httpClient;
            this.basePath = '';
            this.defaultHeaders = new i1.HttpHeaders();
            this.configuration = new CashFlowConfiguration();
        ...
        ChartOfAccountsHttpService.prototype.addToHttpParams = function (httpParams, value, key) {
            if (typeof value === "object" && value instanceof Date === false) {
                httpParams = this.addToHttpParamsRecursive(httpParams, value);
            }
            else {
        ...
        ChartOfAccountsHttpService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
            var _this = this;
            if (value == null) {
                return httpParams;
            }
        ...
        ChartOfAccountsHttpService.prototype.getChartOfAccounts = function (observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var headers = this.defaultHeaders;
            var httpHeaderAcceptSelected = options && options.httpHeaderAccept;
        ...
        ChartOfAccountsHttpService.prototype.getChartOfAccountsUrl = function () {
            return this.configuration.basePath + "/client-api/v1/chart-of-accounts";
        };
        return ChartOfAccountsHttpService;
    }());
    ChartOfAccountsHttpService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: ChartOfAccountsHttpService, deps: [{ token: i1__namespace.HttpClient }, { token: CASH_FLOW_BASE_PATH, optional: true }, { token: CashFlowConfiguration, optional: true }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    ChartOfAccountsHttpService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: ChartOfAccountsHttpService, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: ChartOfAccountsHttpService, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root'
                    }]
    ...
    var ChartOfAccountsHttpServiceGetChartOfAccountsMocksProvider = i2.createMocks([{
    ...
    var ChartOfAccountsHttpServiceMocksProvider = i2.createMocks([
        {
            urlPattern: "/client-api/v1/chart-of-accounts",
            method: "GET",
            responses: [
    ...
    var DefaultCurrencyHttpService = /** @class */ (function () {
        function DefaultCurrencyHttpService(httpClient, basePath, configuration) {
            this.httpClient = httpClient;
            this.basePath = '';
            this.defaultHeaders = new i1.HttpHeaders();
            this.configuration = new CashFlowConfiguration();
        ...
        DefaultCurrencyHttpService.prototype.addToHttpParams = function (httpParams, value, key) {
            if (typeof value === "object" && value instanceof Date === false) {
                httpParams = this.addToHttpParamsRecursive(httpParams, value);
            }
            else {
        ...
        DefaultCurrencyHttpService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
            var _this = this;
            if (value == null) {
                return httpParams;
            }
        ...
        DefaultCurrencyHttpService.prototype.getDefaultCurrency = function (observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var headers = this.defaultHeaders;
            var httpHeaderAcceptSelected = options && options.httpHeaderAccept;
        ...
        DefaultCurrencyHttpService.prototype.getDefaultCurrencyUrl = function () {
            return this.configuration.basePath + "/client-api/v1/default-currency";
        };
        return DefaultCurrencyHttpService;
    }());
    DefaultCurrencyHttpService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: DefaultCurrencyHttpService, deps: [{ token: i1__namespace.HttpClient }, { token: CASH_FLOW_BASE_PATH, optional: true }, { token: CashFlowConfiguration, optional: true }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    DefaultCurrencyHttpService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: DefaultCurrencyHttpService, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: DefaultCurrencyHttpService, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root'
                    }]
    ...
    var DefaultCurrencyHttpServiceGetDefaultCurrencyMocksProvider = i2.createMocks([{
    ...
    var DefaultCurrencyHttpServiceMocksProvider = i2.createMocks([
        {
            urlPattern: "/client-api/v1/default-currency",
            method: "GET",
            responses: [
    ...
    var ForecastConfigurationsHttpService = /** @class */ (function () {
        function ForecastConfigurationsHttpService(httpClient, basePath, configuration) {
            this.httpClient = httpClient;
            this.basePath = '';
            this.defaultHeaders = new i1.HttpHeaders();
            this.configuration = new CashFlowConfiguration();
        ...
        ForecastConfigurationsHttpService.prototype.addToHttpParams = function (httpParams, value, key) {
            if (typeof value === "object" && value instanceof Date === false) {
                httpParams = this.addToHttpParamsRecursive(httpParams, value);
            }
            else {
        ...
        ForecastConfigurationsHttpService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
            var _this = this;
            if (value == null) {
                return httpParams;
            }
        ...
        ForecastConfigurationsHttpService.prototype.getForecastConfigurationById = function (requestParameters, observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var _configurationId = requestParameters["configurationId"];
        ...
        ForecastConfigurationsHttpService.prototype.getForecastConfigurationByIdUrl = function (requestParameters) {
            var _configurationId = requestParameters["configurationId"];
            if (_configurationId === null || _configurationId === undefined) {
                throw new Error('Required parameter configurationId was null or undefined when calling getForecastConfigurationById.');
            }
        ...
        ForecastConfigurationsHttpService.prototype.getForecastConfigurations = function (observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var headers = this.defaultHeaders;
            var httpHeaderAcceptSelected = options && options.httpHeaderAccept;
        ...
        ForecastConfigurationsHttpService.prototype.getForecastConfigurationsUrl = function () {
            return this.configuration.basePath + "/client-api/v1/forecast-configurations";
        };
        ForecastConfigurationsHttpService.prototype.postForecastConfigurations = function (requestParameters, observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var _presentationForecastConfiguration = requestParameters["presentationForecastConfiguration"];
            var headers = this.defaultHeaders;
            var httpHeaderAcceptSelected = options && options.httpHeaderAccept;
            if (httpHeaderAcceptSelected === undefined) {
                var httpHeaderAccepts = [
        ...
        ForecastConfigurationsHttpService.prototype.postForecastConfigurationsUrl = function (requestParameters) {
            var _presentationForecastConfiguration = requestParameters["presentationForecastConfiguration"];
            return this.configuration.basePath + "/client-api/v1/forecast-configurations";
        };
        ForecastConfigurationsHttpService.prototype.putForecastConfigurationById = function (requestParameters, observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var _configurationId = requestParameters["configurationId"];
            if (_configurationId === null || _configurationId === undefined) {
        ...
        ForecastConfigurationsHttpService.prototype.putForecastConfigurationByIdUrl = function (requestParameters) {
            var _configurationId = requestParameters["configurationId"];
            if (_configurationId === null || _configurationId === undefined) {
                throw new Error('Required parameter configurationId was null or undefined when calling putForecastConfigurationById.');
            }
        ...
        return ForecastConfigurationsHttpService;
    }());
    ForecastConfigurationsHttpService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: ForecastConfigurationsHttpService, deps: [{ token: i1__namespace.HttpClient }, { token: CASH_FLOW_BASE_PATH, optional: true }, { token: CashFlowConfiguration, optional: true }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    ForecastConfigurationsHttpService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: ForecastConfigurationsHttpService, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: ForecastConfigurationsHttpService, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root'
                    }]
    ...
    var ForecastConfigurationsHttpServiceGetForecastConfigurationByIdMocksProvider = i2.createMocks([{
    ...
    var ForecastConfigurationsHttpServiceGetForecastConfigurationsMocksProvider = i2.createMocks([{
    ...
    var ForecastConfigurationsHttpServicePostForecastConfigurationsMocksProvider = i2.createMocks([{
            urlPattern: "/client-api/v1/forecast-configurations",
            method: "POST",
            responses: [
                {
    ...
    var ForecastConfigurationsHttpServicePutForecastConfigurationByIdMocksProvider = i2.createMocks([{
            urlPattern: "/client-api/v1/forecast-configurations/{configurationId}",
            method: "PUT",
            responses: [
                {
    ...
    var ForecastConfigurationsHttpServiceMocksProvider = i2.createMocks([
        {
            urlPattern: "/client-api/v1/forecast-configurations/{configurationId}",
            method: "GET",
            responses: [
    ...
    var ForecastsHttpService = /** @class */ (function () {
        function ForecastsHttpService(httpClient, basePath, configuration) {
            this.httpClient = httpClient;
            this.basePath = '';
            this.defaultHeaders = new i1.HttpHeaders();
            this.configuration = new CashFlowConfiguration();
        ...
        ForecastsHttpService.prototype.addToHttpParams = function (httpParams, value, key) {
            if (typeof value === "object" && value instanceof Date === false) {
                httpParams = this.addToHttpParamsRecursive(httpParams, value);
            }
            else {
        ...
        ForecastsHttpService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
            var _this = this;
            if (value == null) {
                return httpParams;
            }
        ...
        ForecastsHttpService.prototype.getForecastById = function (requestParameters, observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var _forecastId = requestParameters["forecastId"];
            ...
            var _cadenceType = requestParameters["cadenceType"];
            ...
            var _projectionAmount = requestParameters["projectionAmount"];
            var _historyAmount = requestParameters["historyAmount"];
        ...
        ForecastsHttpService.prototype.getForecastByIdUrl = function (requestParameters) {
            var _forecastId = requestParameters["forecastId"];
            if (_forecastId === null || _forecastId === undefined) {
                throw new Error('Required parameter forecastId was null or undefined when calling getForecastById.');
            }
        ...
        ForecastsHttpService.prototype.getForecasts = function (observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var headers = this.defaultHeaders;
            var httpHeaderAcceptSelected = options && options.httpHeaderAccept;
        ...
        ForecastsHttpService.prototype.getForecastsUrl = function () {
            return this.configuration.basePath + "/client-api/v1/forecasts";
        };
        return ForecastsHttpService;
    }());
    ForecastsHttpService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: ForecastsHttpService, deps: [{ token: i1__namespace.HttpClient }, { token: CASH_FLOW_BASE_PATH, optional: true }, { token: CashFlowConfiguration, optional: true }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    ForecastsHttpService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: ForecastsHttpService, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: ForecastsHttpService, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root'
                    }]
    ...
    var ForecastsHttpServiceGetForecastByIdMocksProvider = i2.createMocks([{
    ...
    var ForecastsHttpServiceGetForecastsMocksProvider = i2.createMocks([{
    ...
    var ForecastsHttpServiceMocksProvider = i2.createMocks([
        {
            urlPattern: "/client-api/v1/forecasts/{forecastId}",
            method: "GET",
            responses: [
    ...
    var PayablesHttpService = /** @class */ (function () {
        function PayablesHttpService(httpClient, basePath, configuration) {
            this.httpClient = httpClient;
            this.basePath = '';
            this.defaultHeaders = new i1.HttpHeaders();
            this.configuration = new CashFlowConfiguration();
        ...
        PayablesHttpService.prototype.addToHttpParams = function (httpParams, value, key) {
            if (typeof value === "object" && value instanceof Date === false) {
                httpParams = this.addToHttpParamsRecursive(httpParams, value);
            }
            else {
        ...
        PayablesHttpService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
            var _this = this;
            if (value == null) {
                return httpParams;
            }
        ...
        PayablesHttpService.prototype.getPayableById = function (requestParameters, observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var _payableId = requestParameters["payableId"];
        ...
        PayablesHttpService.prototype.getPayableByIdUrl = function (requestParameters) {
            var _payableId = requestParameters["payableId"];
            if (_payableId === null || _payableId === undefined) {
                throw new Error('Required parameter payableId was null or undefined when calling getPayableById.');
            }
        ...
        PayablesHttpService.prototype.getPayables = function (requestParameters, observe, reportProgress, options) {
            var _this = this;
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var _query = requestParameters["query"];
            var _statuses = requestParameters["statuses"];
            ...
            if (_statuses) {
                _statuses.forEach(function (element) {
                    queryParameters = _this.addToHttpParams(queryParameters, element, 'statuses');
                });
            }
        ...
        PayablesHttpService.prototype.getPayablesUrl = function (requestParameters) {
            var _this = this;
            var _query = requestParameters["query"];
            var _statuses = requestParameters["statuses"];
            var _sort = requestParameters["sort"];
        ...
        PayablesHttpService.prototype.putExpectedDateByPayableId = function (requestParameters, observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var _payableId = requestParameters["payableId"];
            if (_payableId === null || _payableId === undefined) {
            ...
            var _putPaymentRequestExpectedDateRequest = requestParameters["putPaymentRequestExpectedDateRequest"];
            var headers = this.defaultHeaders;
            var httpHeaderAcceptSelected = options && options.httpHeaderAccept;
            if (httpHeaderAcceptSelected === undefined) {
                var httpHeaderAccepts = [
        ...
        PayablesHttpService.prototype.putExpectedDateByPayableIdUrl = function (requestParameters) {
            var _payableId = requestParameters["payableId"];
            if (_payableId === null || _payableId === undefined) {
                throw new Error('Required parameter payableId was null or undefined when calling putExpectedDateByPayableId.');
            }
        ...
        return PayablesHttpService;
    }());
    PayablesHttpService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: PayablesHttpService, deps: [{ token: i1__namespace.HttpClient }, { token: CASH_FLOW_BASE_PATH, optional: true }, { token: CashFlowConfiguration, optional: true }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    PayablesHttpService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: PayablesHttpService, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: PayablesHttpService, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root'
                    }]
    ...
    var PayablesHttpServiceGetPayableByIdMocksProvider = i2.createMocks([{
    ...
    var PayablesHttpServiceGetPayablesMocksProvider = i2.createMocks([{
    ...
    var PayablesHttpServicePutExpectedDateByPayableIdMocksProvider = i2.createMocks([{
    ...
    var PayablesHttpServiceMocksProvider = i2.createMocks([
        {
            urlPattern: "/client-api/v1/payables/{payableId}",
            method: "GET",
            responses: [
    ...
    var ReceivablesHttpService = /** @class */ (function () {
        function ReceivablesHttpService(httpClient, basePath, configuration) {
            this.httpClient = httpClient;
            this.basePath = '';
            this.defaultHeaders = new i1.HttpHeaders();
            this.configuration = new CashFlowConfiguration();
        ...
        ReceivablesHttpService.prototype.addToHttpParams = function (httpParams, value, key) {
            if (typeof value === "object" && value instanceof Date === false) {
                httpParams = this.addToHttpParamsRecursive(httpParams, value);
            }
            else {
        ...
        ReceivablesHttpService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
            var _this = this;
            if (value == null) {
                return httpParams;
            }
        ...
        ReceivablesHttpService.prototype.getReceivableById = function (requestParameters, observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var _receivableId = requestParameters["receivableId"];
        ...
        ReceivablesHttpService.prototype.getReceivableByIdUrl = function (requestParameters) {
            var _receivableId = requestParameters["receivableId"];
            if (_receivableId === null || _receivableId === undefined) {
                throw new Error('Required parameter receivableId was null or undefined when calling getReceivableById.');
            }
        ...
        ReceivablesHttpService.prototype.getReceivables = function (requestParameters, observe, reportProgress, options) {
            var _this = this;
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var _query = requestParameters["query"];
        ...
        ReceivablesHttpService.prototype.getReceivablesUrl = function (requestParameters) {
            var _this = this;
            var _query = requestParameters["query"];
            var _statuses = requestParameters["statuses"];
            var _sort = requestParameters["sort"];
        ...
        ReceivablesHttpService.prototype.putExpectedDateByReceivableId = function (requestParameters, observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var _receivableId = requestParameters["receivableId"];
            if (_receivableId === null || _receivableId === undefined) {
        ...
        ReceivablesHttpService.prototype.putExpectedDateByReceivableIdUrl = function (requestParameters) {
            var _receivableId = requestParameters["receivableId"];
            if (_receivableId === null || _receivableId === undefined) {
                throw new Error('Required parameter receivableId was null or undefined when calling putExpectedDateByReceivableId.');
            }
        ...
        return ReceivablesHttpService;
    }());
    ReceivablesHttpService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: ReceivablesHttpService, deps: [{ token: i1__namespace.HttpClient }, { token: CASH_FLOW_BASE_PATH, optional: true }, { token: CashFlowConfiguration, optional: true }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    ReceivablesHttpService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: ReceivablesHttpService, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: ReceivablesHttpService, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root'
                    }]
    ...
    var ReceivablesHttpServiceGetReceivableByIdMocksProvider = i2.createMocks([{
    ...
    var ReceivablesHttpServiceGetReceivablesMocksProvider = i2.createMocks([{
    ...
    var ReceivablesHttpServicePutExpectedDateByReceivableIdMocksProvider = i2.createMocks([{
    ...
    var ReceivablesHttpServiceMocksProvider = i2.createMocks([
        {
            urlPattern: "/client-api/v1/receivables/{receivableId}",
            method: "GET",
            responses: [
    ...
    var SmeHttpService = /** @class */ (function () {
        function SmeHttpService(httpClient, basePath, configuration) {
            this.httpClient = httpClient;
            this.basePath = '';
            this.defaultHeaders = new i1.HttpHeaders();
            this.configuration = new CashFlowConfiguration();
        ...
        SmeHttpService.prototype.addToHttpParams = function (httpParams, value, key) {
            if (typeof value === "object" && value instanceof Date === false) {
                httpParams = this.addToHttpParamsRecursive(httpParams, value);
            }
            else {
        ...
        SmeHttpService.prototype.addToHttpParamsRecursive = function (httpParams, value, key) {
            var _this = this;
            if (value == null) {
                return httpParams;
            }
        ...
        SmeHttpService.prototype.getAccountingAuthorization = function (observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var headers = this.defaultHeaders;
            var httpHeaderAcceptSelected = options && options.httpHeaderAccept;
        ...
        SmeHttpService.prototype.getAccountingAuthorizationUrl = function () {
            return this.configuration.basePath + "/client-api/v1/sme/accounting-authorization";
        };
        SmeHttpService.prototype.getSme = function (observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var headers = this.defaultHeaders;
            var httpHeaderAcceptSelected = options && options.httpHeaderAccept;
        ...
        SmeHttpService.prototype.getSmeUrl = function () {
            return this.configuration.basePath + "/client-api/v1/sme";
        };
        SmeHttpService.prototype.postSme = function (requestParameters, observe, reportProgress, options) {
            if (observe === void 0) { observe = 'body'; }
            if (reportProgress === void 0) { reportProgress = false; }
            var _presentationCreateSmeRequest = requestParameters["presentationCreateSmeRequest"];
            var headers = this.defaultHeaders;
            var httpHeaderAcceptSelected = options && options.httpHeaderAccept;
            if (httpHeaderAcceptSelected === undefined) {
                var httpHeaderAccepts = [
        ...
        SmeHttpService.prototype.postSmeUrl = function (requestParameters) {
            var _presentationCreateSmeRequest = requestParameters["presentationCreateSmeRequest"];
            return this.configuration.basePath + "/client-api/v1/sme";
        };
        return SmeHttpService;
    }());
    SmeHttpService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: SmeHttpService, deps: [{ token: i1__namespace.HttpClient }, { token: CASH_FLOW_BASE_PATH, optional: true }, { token: CashFlowConfiguration, optional: true }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    SmeHttpService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: SmeHttpService, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0__namespace, type: SmeHttpService, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root'
                    }]
    ...
    var SmeHttpServiceGetAccountingAuthorizationMocksProvider = i2.createMocks([{
    ...
    var SmeHttpServiceGetSmeMocksProvider = i2.createMocks([{
    ...
    var SmeHttpServicePostSmeMocksProvider = i2.createMocks([{
            urlPattern: "/client-api/v1/sme",
            method: "POST",
            responses: [
                {
    ...
    var SmeHttpServiceMocksProvider = i2.createMocks([
        {
            urlPattern: "/client-api/v1/sme/accounting-authorization",
            method: "GET",
            responses: [
    ...
    exports.AccountingPlatformsHttpService = AccountingPlatformsHttpService;
    exports.AccountingPlatformsHttpServiceGetAccountingPlatformsMocksProvider = AccountingPlatformsHttpServiceGetAccountingPlatformsMocksProvider;
    exports.AccountingPlatformsHttpServiceMocksProvider = AccountingPlatformsHttpServiceMocksProvider;
    exports.CASH_FLOW_BASE_PATH = CASH_FLOW_BASE_PATH;
    exports.COLLECTION_FORMATS = COLLECTION_FORMATS;
    exports.CONFIG_TOKEN = CONFIG_TOKEN;
    exports.CashFlowApiModule = CashFlowApiModule;
    exports.CashFlowConfiguration = CashFlowConfiguration;
    exports.ChartOfAccountsHttpService = ChartOfAccountsHttpService;
    exports.ChartOfAccountsHttpServiceGetChartOfAccountsMocksProvider = ChartOfAccountsHttpServiceGetChartOfAccountsMocksProvider;
    exports.ChartOfAccountsHttpServiceMocksProvider = ChartOfAccountsHttpServiceMocksProvider;
    exports.DefaultCurrencyHttpService = DefaultCurrencyHttpService;
    exports.DefaultCurrencyHttpServiceGetDefaultCurrencyMocksProvider = DefaultCurrencyHttpServiceGetDefaultCurrencyMocksProvider;
    exports.DefaultCurrencyHttpServiceMocksProvider = DefaultCurrencyHttpServiceMocksProvider;
    exports.ForecastConfigurationsHttpService = ForecastConfigurationsHttpService;
    exports.ForecastConfigurationsHttpServiceGetForecastConfigurationByIdMocksProvider = ForecastConfigurationsHttpServiceGetForecastConfigurationByIdMocksProvider;
    exports.ForecastConfigurationsHttpServiceGetForecastConfigurationsMocksProvider = ForecastConfigurationsHttpServiceGetForecastConfigurationsMocksProvider;
    exports.ForecastConfigurationsHttpServiceMocksProvider = ForecastConfigurationsHttpServiceMocksProvider;
    exports.ForecastConfigurationsHttpServicePostForecastConfigurationsMocksProvider = ForecastConfigurationsHttpServicePostForecastConfigurationsMocksProvider;
    exports.ForecastConfigurationsHttpServicePutForecastConfigurationByIdMocksProvider = ForecastConfigurationsHttpServicePutForecastConfigurationByIdMocksProvider;
    exports.ForecastsHttpService = ForecastsHttpService;
    exports.ForecastsHttpServiceGetForecastByIdMocksProvider = ForecastsHttpServiceGetForecastByIdMocksProvider;
    exports.ForecastsHttpServiceGetForecastsMocksProvider = ForecastsHttpServiceGetForecastsMocksProvider;
    exports.ForecastsHttpServiceMocksProvider = ForecastsHttpServiceMocksProvider;
    exports.PayablesHttpService = PayablesHttpService;
    exports.PayablesHttpServiceGetPayableByIdMocksProvider = PayablesHttpServiceGetPayableByIdMocksProvider;
    exports.PayablesHttpServiceGetPayablesMocksProvider = PayablesHttpServiceGetPayablesMocksProvider;
    exports.PayablesHttpServiceMocksProvider = PayablesHttpServiceMocksProvider;
    exports.PayablesHttpServicePutExpectedDateByPayableIdMocksProvider = PayablesHttpServicePutExpectedDateByPayableIdMocksProvider;
    exports.PresentationAccountCategory = PresentationAccountCategory;
    exports.PresentationAuthorizationStatus = PresentationAuthorizationStatus;
    exports.PresentationCounterpartyType = PresentationCounterpartyType;
    exports.PresentationPayableStatus = PresentationPayableStatus;
    exports.PresentationReceivableStatus = PresentationReceivableStatus;
    exports.ReceivablesHttpService = ReceivablesHttpService;
    exports.ReceivablesHttpServiceGetReceivableByIdMocksProvider = ReceivablesHttpServiceGetReceivableByIdMocksProvider;
    exports.ReceivablesHttpServiceGetReceivablesMocksProvider = ReceivablesHttpServiceGetReceivablesMocksProvider;
    exports.ReceivablesHttpServiceMocksProvider = ReceivablesHttpServiceMocksProvider;
    exports.ReceivablesHttpServicePutExpectedDateByReceivableIdMocksProvider = ReceivablesHttpServicePutExpectedDateByReceivableIdMocksProvider;
    exports.SmeHttpService = SmeHttpService;
    exports.SmeHttpServiceGetAccountingAuthorizationMocksProvider = SmeHttpServiceGetAccountingAuthorizationMocksProvider;
    exports.SmeHttpServiceGetSmeMocksProvider = SmeHttpServiceGetSmeMocksProvider;
    exports.SmeHttpServiceMocksProvider = SmeHttpServiceMocksProvider;
    exports.SmeHttpServicePostSmeMocksProvider = SmeHttpServicePostSmeMocksProvider;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=backbase-cashflow-http-ang.umd.js.map
