 ...
 *
 */
export declare class CurrencyAmountSelectorComponent implements ControlValueAccessor, OnInit, OnChanges, AfterViewInit {
    private readonly el;
     ...
     */
    currencySelectorExtended: boolean;
    /**
     * The currency selector config map.
     */
    currencySelectorConfig: CurrencySelectorConfig;
    /**
    ...
    readonly idListAttr: (...tokens: any[]) => string;
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<CurrencyAmountSelectorComponent, [null, null, null, { optional: true; self: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<CurrencyAmountSelectorComponent, "bb-currency-amount-selector", never, { "decMaxLen": "decMaxLen"; "decMinLen": "decMinLen"; "placeholder": "placeholder"; "resultType": "resultType"; "integer": "integer"; "required": "required"; "readonly": "readonly"; "disabled": "disabled"; "integerLabelSrOnly": "integerLabelSrOnly"; "decimalLabelSrOnly": "decimalLabelSrOnly"; "currencies": "currencies"; "currencySelectorExtended": "currencySelectorExtended"; "currencySelectorConfig": "currencySelectorConfig"; "isRightAligned": "isRightAligned"; "integerId": "integerId"; "decimalId": "decimalId"; "integerLabel": "integerLabel"; "decimalLabel": "decimalLabel"; "currencyLabel": "currencyLabel"; "labelClasses": "labelClasses"; "allowNegativeValue": "allowNegativeValue"; "currencyListAriaLabel": "currencyListAriaLabel"; "currencyListWithOnItemAriaLabel": "currencyListWithOnItemAriaLabel"; "ariaDescribedby": "aria-describedby"; "ariaLabelledby": "aria-labelledby"; "ariaInvalid": "aria-invalid"; }, {}, never, ["[bbValidationMessage]"]>;
}
