...
import { PaymentComponents, ProductKinds, AccountBalances, } from '../models/form-items.model';
...
import { scheduleFrequencyToggleDependants, scheduleStartDateOnDestroyHook, scheduleEndTypeToggleDependants, scheduleEndDateOnInitHook, toggleForAmountOptions, internalTransferScheduleFreqOnInitHook, internalTransferOnDestroyHook, internalTransferScheduleAlertOnInitHook, internalTransAmountOptToggleDependants, internalTransScheduleStartDateOnInitHook, internalTransferEndTypeOnInitHook, internalTransferRepeatOnInitHook, } from '../helpers/schedule-config-helpers';
    ...
    fields: [
        {
            ...
            options: {
                ...
                activateDependantsOn: (value, control) => {
                    var _a, _b;
                    return toggleForAmountOptions(value, control, (_b = (_a = remittanceInfo.fields[1]) === null || _a === void 0 ? void 0 : _a.options) === null || _b === void 0 ? void 0 : _b.amountOptions);
                },
                validationMessages: [
                    {
                        name: 'required',
