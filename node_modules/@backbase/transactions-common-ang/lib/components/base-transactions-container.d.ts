...
export declare class BaseTransactionsContainer implements OnInit, OnDestroy {
     ...
     */
    selectedAccount: Observable<Array<string> | undefined> | undefined;
    /**
    ...
    set maxNavPagesValue(value: number | undefined);
    set paginationTypeValue(value: string | undefined);
    set showControlsValue(value: boolean | undefined);
    set showChangeCategoryValue(value: boolean | undefined);
    set showPendingTransactionsOnTopValue(value: boolean | undefined);
    set showCheckImageValue(value: boolean | undefined);
    set showManageNotesValue(value: boolean | undefined);
    set getOrPostEndpointsValue(value: EndpointType | undefined);
    set disputeByBillingStatusValue(value: string | boolean | undefined);
    set disputeEligibilityDaysValue(value: number | undefined);
    set disputeTransactionTypesValue(value: string | undefined);
    set enableDisputeAndInquiryValue(value: string | boolean | undefined);
