...
$entitlement-wizard-configuration-menu-background: $color-neutral-lighter !default;
$entitlement-wizard-sidemenu-item-padding: $sizer-xl 0 $sizer-xl $sizer-lg !default;
$entitlement-wizard-sidemenu-min-width: 300px !default;
$entitlement-wizard-sidemenu-max-width: 400px !default;
$entitlement-wizard-configuration-menu-content: $sizer-xl !default;
