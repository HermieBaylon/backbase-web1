...
$manage-pockets-create-details-image-container-bottom-margin: $spacer-xl !default;
...
$manage-pockets-create-details-image-active-border: 2px solid $color-primary !default;
$manage-pockets-create-details-image-active-box-shadow: $box-shadow-sm !default;

$manage-pockets-create-details-pocket-stack-item-bottom-margin: $sizer-lg !default;
...
.bb-manage-pockets-create-details__pocket-image-container {
  @include media-breakpoint-down(sm) {
    margin-bottom: $manage-pockets-create-details-image-container-bottom-margin;
  }
}
...
.bb-manage-pockets-create-details__modal-image-item {
  margin-bottom: $manage-pockets-create-details-pocket-stack-item-bottom-margin;
  cursor: pointer;
