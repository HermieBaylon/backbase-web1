...
.bb-transactions-table__filter {
  ...
  border-top: solid $transaction-table-filter-background-border-color 1px;
  border-bottom: solid $transaction-table-filter-background-border-color 1px;
}
...
.bb-card:not(.bb-card--ignore) {
  .bb-transactions-table__filter {
    margin-right: $transaction-table-filter-margin-md;
    margin-left: $transaction-table-filter-margin-md;
    padding-right: $transaction-table-filter-padding;
    padding-left: $transaction-table-filter-padding;
  }

  &.bb-card--sm {
    .bb-transactions-table__filter {
      margin-right: $transaction-table-filter-margin-sm;
      margin-left: $transaction-table-filter-margin-sm;
    }
  }

  &.bb-card--lg {
    .bb-transactions-table__filter {
      margin-right: $transaction-table-filter-margin-lg;
      margin-left: $transaction-table-filter-margin-lg;
    }
  }
}
