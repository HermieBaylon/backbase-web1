...
const PORTFOLIO_SUMMARY_BASE_PATH = new InjectionToken('PORTFOLIO_SUMMARY_BASE_PATH');
...
class PortfolioSummaryConfiguration {
...
const CONFIG_TOKEN = new InjectionToken('api-data-module PortfolioSummaryConfiguration');

class PortfolioSummaryApiModule {
...
PortfolioSummaryApiModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0, type: PortfolioSummaryApiModule, deps: [{ token: PortfolioSummaryApiModule, optional: true, skipSelf: true }, { token: i1.HttpClient, optional: true }, { token: i2.DataModulesManager, optional: true }, { token: PortfolioSummaryConfiguration }], target: i0.ɵɵFactoryTarget.NgModule });
PortfolioSummaryApiModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0, type: PortfolioSummaryApiModule });
PortfolioSummaryApiModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0, type: PortfolioSummaryApiModule, providers: [], imports: [[]] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0, type: PortfolioSummaryApiModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [],
                    declarations: [],
        ...
        }], ctorParameters: function () { return [{ type: PortfolioSummaryApiModule, decorators: [{
                    type: Optional
                }, {
                    type: SkipSelf
...
class CurrencyClientHttpService {
    ...
    deleteDefaultCurrency(observe = 'body', reportProgress = false, options) {
    ...
    deleteDefaultCurrencyUrl() {
        return `${this.configuration.basePath}/client-api/v2/currency/default`;
    }
    getSupportedCurrency(observe = 'body', reportProgress = false, options) {
        let headers = this.defaultHeaders;
        let httpHeaderAcceptSelected = options && options.httpHeaderAccept;
        if (httpHeaderAcceptSelected === undefined) {
            const httpHeaderAccepts = [
    ...
    getSupportedCurrencyUrl() {
        return `${this.configuration.basePath}/client-api/v2/currency`;
    }
    putDefaultCurrency(requestParameters, observe = 'body', reportProgress = false, options) {
    ...
    putDefaultCurrencyUrl(requestParameters) {
        const _currencyCode = requestParameters["currencyCode"];
        return `${this.configuration.basePath}/client-api/v2/currency/default`;
    }
}
CurrencyClientHttpService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0, type: CurrencyClientHttpService, deps: [{ token: i1.HttpClient }, { token: PORTFOLIO_SUMMARY_BASE_PATH, optional: true }, { token: PortfolioSummaryConfiguration, optional: true }], target: i0.ɵɵFactoryTarget.Injectable });
CurrencyClientHttpService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0, type: CurrencyClientHttpService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0, type: CurrencyClientHttpService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
const CurrencyClientHttpServiceDeleteDefaultCurrencyMocksProvider = createMocks([{
...
const CurrencyClientHttpServiceGetSupportedCurrencyMocksProvider = createMocks([{
...
const CurrencyClientHttpServicePutDefaultCurrencyMocksProvider = createMocks([{
        urlPattern: "/client-api/v2/currency/default",
        method: "PUT",
        responses: [
            {
...
const CurrencyClientHttpServiceMocksProvider = createMocks([
    {
        urlPattern: "/client-api/v2/currency/default",
        method: "DELETE",
        responses: [
...
class PortfolioSummaryClientApiHttpService {
    constructor(httpClient, basePath, configuration) {
        this.httpClient = httpClient;
        this.basePath = '';
        this.defaultHeaders = new HttpHeaders();
...
PortfolioSummaryClientApiHttpService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0, type: PortfolioSummaryClientApiHttpService, deps: [{ token: i1.HttpClient }, { token: PORTFOLIO_SUMMARY_BASE_PATH, optional: true }, { token: PortfolioSummaryConfiguration, optional: true }], target: i0.ɵɵFactoryTarget.Injectable });
PortfolioSummaryClientApiHttpService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0, type: PortfolioSummaryClientApiHttpService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0, type: PortfolioSummaryClientApiHttpService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
const PortfolioSummaryClientApiHttpServiceDeleteFavoriteByIbanMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceDeleteFavoriteByPortfolioIdMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceDeleteRemovePortfoliosFromCustomListByUuidAndPortfolioIbanListMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceDeleteUuidByUuidMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceExportPortfolioTransactionsMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceGetAggregationMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceGetBenchmarkDataByPortfolioIdMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceGetChartDataByPortfolioIdMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceGetChartDataByPortfolioIdChartMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceGetCustomlistMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceGetPerformancebenchmarksByPortfolioIdMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceGetPortfolioAllocationsByAssetClassByPortfolioIdMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceGetPortfolioAllocationsByCurrencyByPortfolioIdMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceGetPortfolioIdByPortfolioIdMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceGetPortfolioPositionsByPortfolioIdMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceGetPortfoliosummaryMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceGetTransactionFilterOptionsByPortfolioIdMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceGetTransactionIdByPortfolioIdAndTransactionIdMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServiceGetTransactionsByPortfolioIdMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServicePostAddPortfoliosToCustomListByUuidMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServicePostCreatePortfolioCustomListMocksProvider = createMocks([{
        urlPattern: "/client-api/v2/portfoliosummary/custom-list",
        method: "POST",
        responses: [
            {
...
const PortfolioSummaryClientApiHttpServicePostSavePortfolioAliasMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServicePostSavePortfoliosOrderingMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServicePutMarkPortfolioAsFavoriteMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServicePutMarkPortfolioAsFavoriteUnfavoriteMocksProvider = createMocks([{
...
const PortfolioSummaryClientApiHttpServicePutRenameTheCustomListByUuidMocksProvider = createMocks([{
        urlPattern: "/client-api/v2/portfoliosummary/custom-list/{uuid}",
        method: "PUT",
        responses: [
            {
...
const PortfolioSummaryClientApiHttpServiceMocksProvider = createMocks([
    {
        urlPattern: "/client-api/v2/portfoliosummary/favorites/{iban}",
        method: "DELETE",
        responses: [
...
class TransactionCategoriesClientHttpService {
    constructor(httpClient, basePath, configuration) {
        this.httpClient = httpClient;
        this.basePath = '';
        this.defaultHeaders = new HttpHeaders();
    ...
    getTransactionCategories(observe = 'body', reportProgress = false, options) {
        let headers = this.defaultHeaders;
        let httpHeaderAcceptSelected = options && options.httpHeaderAccept;
        if (httpHeaderAcceptSelected === undefined) {
            const httpHeaderAccepts = [
    ...
    getTransactionCategoriesUrl() {
        return `${this.configuration.basePath}/client-api/v2/transaction-categories`;
    }
}
TransactionCategoriesClientHttpService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0, type: TransactionCategoriesClientHttpService, deps: [{ token: i1.HttpClient }, { token: PORTFOLIO_SUMMARY_BASE_PATH, optional: true }, { token: PortfolioSummaryConfiguration, optional: true }], target: i0.ɵɵFactoryTarget.Injectable });
TransactionCategoriesClientHttpService.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0, type: TransactionCategoriesClientHttpService, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.15", ngImport: i0, type: TransactionCategoriesClientHttpService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
const TransactionCategoriesClientHttpServiceGetTransactionCategoriesMocksProvider = createMocks([{
...
const TransactionCategoriesClientHttpServiceMocksProvider = createMocks([
    {
        urlPattern: "/client-api/v2/transaction-categories",
        method: "GET",
        responses: [
...
export { COLLECTION_FORMATS, CONFIG_TOKEN, CurrencyClientHttpService, CurrencyClientHttpServiceDeleteDefaultCurrencyMocksProvider, CurrencyClientHttpServiceGetSupportedCurrencyMocksProvider, CurrencyClientHttpServiceMocksProvider, CurrencyClientHttpServicePutDefaultCurrencyMocksProvider, FileTypeEnum, PORTFOLIO_SUMMARY_BASE_PATH, PortfolioSummaryApiModule, PortfolioSummaryClientApiHttpService, PortfolioSummaryClientApiHttpServiceDeleteFavoriteByIbanMocksProvider, PortfolioSummaryClientApiHttpServiceDeleteFavoriteByPortfolioIdMocksProvider, PortfolioSummaryClientApiHttpServiceDeleteRemovePortfoliosFromCustomListByUuidAndPortfolioIbanListMocksProvider, PortfolioSummaryClientApiHttpServiceDeleteUuidByUuidMocksProvider, PortfolioSummaryClientApiHttpServiceExportPortfolioTransactionsMocksProvider, PortfolioSummaryClientApiHttpServiceGetAggregationMocksProvider, PortfolioSummaryClientApiHttpServiceGetBenchmarkDataByPortfolioIdMocksProvider, PortfolioSummaryClientApiHttpServiceGetChartDataByPortfolioIdChartMocksProvider, PortfolioSummaryClientApiHttpServiceGetChartDataByPortfolioIdMocksProvider, PortfolioSummaryClientApiHttpServiceGetCustomlistMocksProvider, PortfolioSummaryClientApiHttpServiceGetPerformancebenchmarksByPortfolioIdMocksProvider, PortfolioSummaryClientApiHttpServiceGetPortfolioAllocationsByAssetClassByPortfolioIdMocksProvider, PortfolioSummaryClientApiHttpServiceGetPortfolioAllocationsByCurrencyByPortfolioIdMocksProvider, PortfolioSummaryClientApiHttpServiceGetPortfolioIdByPortfolioIdMocksProvider, PortfolioSummaryClientApiHttpServiceGetPortfolioPositionsByPortfolioIdMocksProvider, PortfolioSummaryClientApiHttpServiceGetPortfoliosummaryMocksProvider, PortfolioSummaryClientApiHttpServiceGetTransactionFilterOptionsByPortfolioIdMocksProvider, PortfolioSummaryClientApiHttpServiceGetTransactionIdByPortfolioIdAndTransactionIdMocksProvider, PortfolioSummaryClientApiHttpServiceGetTransactionsByPortfolioIdMocksProvider, PortfolioSummaryClientApiHttpServiceMocksProvider, PortfolioSummaryClientApiHttpServicePostAddPortfoliosToCustomListByUuidMocksProvider, PortfolioSummaryClientApiHttpServicePostCreatePortfolioCustomListMocksProvider, PortfolioSummaryClientApiHttpServicePostSavePortfolioAliasMocksProvider, PortfolioSummaryClientApiHttpServicePostSavePortfoliosOrderingMocksProvider, PortfolioSummaryClientApiHttpServicePutMarkPortfolioAsFavoriteMocksProvider, PortfolioSummaryClientApiHttpServicePutMarkPortfolioAsFavoriteUnfavoriteMocksProvider, PortfolioSummaryClientApiHttpServicePutRenameTheCustomListByUuidMocksProvider, PortfolioSummaryConfiguration, TransactionCategoriesClientHttpService, TransactionCategoriesClientHttpServiceGetTransactionCategoriesMocksProvider, TransactionCategoriesClientHttpServiceMocksProvider };
//# sourceMappingURL=backbase-portfolio-summary-http-ang.js.map
