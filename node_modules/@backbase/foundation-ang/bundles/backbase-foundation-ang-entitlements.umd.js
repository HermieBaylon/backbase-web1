(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common/http'),require('@angular/router'),exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/common/http'), require('@angular/router')) :
    typeof define === 'function' && define.amd ? define('@backbase/foundation-ang/entitlements', ['@angular/core','@angular/common/http','@angular/router','exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/common/http', '@angular/router'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.common.http,global.ng.router,(global.backbase = global.backbase || {}, global.backbase["foundation-ang"] = global.backbase["foundation-ang"] || {}, global.backbase["foundation-ang"].entitlements = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.ng.common.http, global.ng.router));
})(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, i0, rxjs, operators, i1, i2) { 'use strict';
...
ConditionsService.ɵfac = function ConditionsService_Factory(t) { return new (t || ConditionsService)(ɵngcc0.ɵɵinject(ɵngcc1.HttpClient), ɵngcc0.ɵɵinject(ENTITLEMENTS_CONFIG, 8)); };
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ConditionsService, [{
        type: i0.Injectable,
        args: [{
                providedIn: 'root'
            }]
...
IfEntitlementsDirective.ɵfac = function IfEntitlementsDirective_Factory(t) { return new (t || IfEntitlementsDirective)(ɵngcc0.ɵɵdirectiveInject(ConditionsService), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.TemplateRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef)); };
IfEntitlementsDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: IfEntitlementsDirective, selectors: [["", "bbIfEntitlements", ""]], inputs: { bbIfEntitlements: "bbIfEntitlements", bbIfEntitlementsElse: "bbIfEntitlementsElse" } });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(IfEntitlementsDirective, [{
        type: i0.Directive,
        args: [{
                selector: '[bbIfEntitlements]'
            }]
    }], function () { return [{ type: ConditionsService }, { type: ɵngcc0.TemplateRef }, { type: ɵngcc0.ViewContainerRef }, { type: ɵngcc0.ChangeDetectorRef }]; }, { bbIfEntitlements: [{
            type: i0.Input
        }], bbIfEntitlementsElse: [{
            type: i0.Input
        }] }); })();
...
EntitlementsModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: EntitlementsModule });
EntitlementsModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [{ provide: CONDITIONS, useExisting: ConditionsService }] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EntitlementsModule, [{
        type: i0.NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(EntitlementsModule, { declarations: [IfEntitlementsDirective], exports: [IfEntitlementsDirective] }); })();
...
EntitlementsGuard.ɵfac = function EntitlementsGuard_Factory(t) { return new (t || EntitlementsGuard)(ɵngcc0.ɵɵinject(ConditionsService), ɵngcc0.ɵɵinject(ɵngcc2.Router)); };
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EntitlementsGuard, [{
        type: i0.Injectable,
        args: [{
                providedIn: 'root'
            }]
    }], function () { return [{ type: ConditionsService }, { type: ɵngcc2.Router }]; }, null); })();
