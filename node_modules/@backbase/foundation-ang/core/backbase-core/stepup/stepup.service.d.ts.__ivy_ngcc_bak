import { ComponentRef, ViewContainerRef, ComponentFactoryResolver, EventEmitter, InjectionToken } from '@angular/core';
import { StepUpConfig } from './stepup.interceptor';
import { CustomStepUpConfig } from './stepup.module';
import { HttpErrorResponse } from '@angular/common/http';
/**
 * @deprecated Will be removed in v7.0.0
 */
export declare const STEPUP_CONFIG: InjectionToken<StepUpConfig>;
/**
 * @deprecated Will be removed in v7.0.0
 ...
 */
export declare type StepUpComponentType = new (...args: Array<any>) => StepUpComponent;
/**
 * @deprecated Will be removed in v7.0.0
 */
export declare class StepUpService {
    private readonly resolver;
    private stepupComponentRef;
    private readonly stepupConfig;
    constructor(resolver: ComponentFactoryResolver, stepupConfigParam: CustomStepUpConfig);
    get stepupComponent(): ComponentRef<StepUpComponent>;
    createStepUpComponent(stepupContainer: ViewContainerRef): void;
}
