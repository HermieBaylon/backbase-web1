(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@backbase/communication-property', ['exports'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.backbase = global.backbase || {}, global.backbase["communication-property"] = {})));
    ...
    ***************************************************************************** */
    ...
    var CommunicationDefinition = /** @class */ (function () {
         ...
         */
        CommunicationDefinition.prototype.equals = function (other) {
    ...
    function human() {
        return {
            fromProperty: function (value) {
                var splitAt = value.indexOf(' ');
                if (splitAt === -1) {
                    return undefined;
                }
                var transport = value.substr(0, splitAt);
                var param = value.substr(splitAt + 1);
                if (param.includes(' ')) {
                    return undefined;
                }
                return new CommunicationDefinition(transport, param);
            },
            toProperty: function (definition) {
    ...
    function mangled() {
        return {
            fromProperty: function (value) {
                ...
                var splitAt = blob.indexOf(' ');
                var transport = blob.substr(0, splitAt);
                var param = blob.substr(splitAt + 1);
                return new CommunicationDefinition(transport, param);
            },
            toProperty: function (definition) {
                var mangledValue = btoa(definition.transport + " " + definition.param);
    ...
    function mangledJson() {
        return {
            ...
            toProperty: function (definition) {
                var json = JSON.stringify({ transport: definition.transport, param: definition.param });
                return ":1:" + json;
            },
        };
    }
    function tryParse(inputValue, parsers, parse) {
        ...
        try {
            for (var parsers_1 = __values(parsers), parsers_1_1 = parsers_1.next(); !parsers_1_1.done; parsers_1_1 = parsers_1.next()) {
                ...
                var result = parse(parser, inputValue);
                if (result !== undefined) {
                    return result;
                }
            }
    ...
    function combined(parsers) {
        return {
            fromProperty: function (inputValue) {
                return tryParse(inputValue, parsers, function (parser, value) { return parser.fromProperty(value); });
            },
            toProperty: function (definition) {
                var first = parsers[0];
     ...
     */
    var serializerDeserializer = combined([mangledJson(), mangled(), human()]);

    /**
     * Generated bundle index. Do not edit.
     */

    exports.CommunicationDefinition = CommunicationDefinition;
    exports.serializerDeserializer = serializerDeserializer;
    exports["ɵa"] = human;
    exports["ɵb"] = mangled;
    exports["ɵc"] = mangledJson;
    exports["ɵd"] = combined;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=backbase-communication-property.umd.js.map
