...
import * as i1 from "../../services/billpay-payment-schedule.service";
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.16", ngImport: i0, type: BillpayPaymentReviewCardComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1.BillpayPaymentScheduleService }]; }, propDecorators: { paymentReview: [{
                type: Input
            }], accountNumberMask: [{
                type: Input
            }], frequencyLabel: [{
...
//# sourceMappingURL=billpay-payment-review-card.component.js.map